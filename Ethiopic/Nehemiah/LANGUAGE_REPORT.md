...
|---|---|
| **Book** | Nehemiah |
| **Overall Classification** | Amharic |
| **Ge'ez-to-Amharic Ratio** | 0.703 |
| **Confidence** | High — classification is statistically robust |
| **Text Source** | EOTXC_OCR |
| **Total Verses** | 440 |
| **Ge'ez Verses** | 0 |
| **Amharic Verses** | 440 |
| **Mixed/Uncertain Verses** | 0 |
| **Empty Verses** | 0 |
| **Note** | Known Amharic placeholder. Quick scan ratio: 0.703 |

**Verse breakdown:** 0.0% Ge'ez · 100.0% Amharic · 0.0% Mixed/Uncertain
